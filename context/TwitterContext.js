...
export const TwitterProvider = ({ children }) => {
  ...
  /* To initiate metamask wallet connection */
  ...
  /* Creates a user in sanity db if the user doesnt already have one */ 
  const createUserAccount = async (userWalletAddress = currentAccount) => {
    ...
    try {
      const userDoc = {
        ...
        profileImage: 'https://pbs.twimg.com/profile_images/1523770549264125955/5sBDl1lV_400x400.jpg',
